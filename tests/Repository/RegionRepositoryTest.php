...
{
    public function testCreateQueryBuilderFromDto(): void
    {
        ...
        static::assertSame(
            ...
            $repository->createQueryBuilderFromDto('r', new RegionQueryDto(null, null))->getDQL()
        );

        static::assertSame(
            'SELECT r FROM Siganushka\RegionBundle\Tests\Fixtures\TestRegion r WHERE r.parent = :parent ORDER BY r.parent ASC, r.code ASC',
            $repository->createQueryBuilderFromDto('r', new RegionQueryDto('100000', null))->getDQL()
        );
        ...
        static::assertSame(
            ...
            $repository->createQueryBuilderFromDto('r', new RegionQueryDto('100000', 'foo'))->getDQL()
        );
        ...
        static::assertSame(
            ...
            $repository->createQueryBuilderFromDto('r', new RegionQueryDto(null, 'foo'))->getDQL()
        );
    }
